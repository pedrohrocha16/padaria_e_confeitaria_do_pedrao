...
const History = (props: Props) => {
   return (
      <div className='flex flex-col items-start justify-center w-[100%] min-h-[200px] p-1 sm:p-[5vw] md:p-[8%] lg:p-[2%] sm:m-4'>
         <div className='flex flex-row gap-2 mb-[25px] sm:ml-[10%] lg:ml-[15%]'>
            ...
            <div className='flex flex-col p-2 text-left w-[70%] ml-2'>
               ...
               <div className=' flex flex-row'>
                  <FcHighPriority className="flex items-start text-[30px] mr-2" />
                  <p><strong>Estamos oferecendo delivery, basta fazer o pedido pelo site ou pelo WhatsApp. Entregas: 08:00hrs - 18:00hrs segunda à sexta.</strong></p>
               </div>
            </div>
         </div>
      </div>
